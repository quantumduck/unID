...
var _typeof = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (e) {
  ...
  return function e(t, n, r) {
    function a(u, s) {
      if (!n[u]) {
        if (!t[u]) {
          var c = "function" == typeof require && require;if (!s && c) return c(u, !0);if (o) return o(u, !0);var i = new Error("Cannot find module '" + u + "'");throw i.code = "MODULE_NOT_FOUND", i;
        }var l = n[u] = { exports: {} };t[u][0].call(l.exports, function (e) {
          var n = t[u][1][e];return a(n ? n : e);
        }, l, l.exports, e, t, n, r);
      }return n[u].exports;
      ...
      var n = e("github-calendar-parser"),
          ...
          o = e("formatoid"),
          u = "MMM D, YYYY",
          s = "MMMM D";t.exports = function (e, t, c) {
        e = r(e), c = c || {}, c.summary_text = c.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + t + '" target="blank">@' + t + "</a>", c.global_stats === !1 && (e.style.minHeight = "175px"), c.proxy = c.proxy || function (e) {
          ...
          return fetch(c.proxy("https://github.com/" + t)).then(function (e) {
            ...
            var i = document.createElement("div");i.innerHTML = t;var f = i.querySelector(".js-contribution-graph");if (f.querySelector(".float-left.text-gray").innerHTML = c.summary_text, f.querySelector("include-fragment")) setTimeout(l, 500);else {
              if (c.global_stats !== !1) {
                var d = n(r("svg", f).outerHTML),
                    ...
                    y = r("<div>", { "class": "contrib-column contrib-column-first table-column", html: '<span class="text-muted">Contributions in the last year</span>\n                               <span class="contrib-number">' + d.last_year + ' total</span>\n                               <span class="text-muted">' + o(a.subtract(new Date(), 1, "year"), u) + " – " + o(new Date(), u) + "</span>" }),
                    m = r("<div>", { "class": "contrib-column table-column", html: '<span class="text-muted">Longest streak</span>\n                               <span class="contrib-number">' + d.longest_streak + ' days</span>\n                               <span class="text-muted">' + g + "</span>" }),
                    b = r("<div>", { "class": "contrib-column table-column", html: '<span class="text-muted">Current streak</span>\n                               <span class="contrib-number">' + d.current_streak + ' days</span>\n                               <span class="text-muted">' + p + "</span>" });f.appendChild(y), f.appendChild(m), f.appendChild(b);
      ...
      function n(e) {
        return function t(n, r, a) {
          switch (r = e * r, a) {case "years":case "year":
              ...
              throw new Error("Invalid range: " + a);}return n;
        };
      ...
      var n = e("github-calendar-legend");t.exports = function (e) {
        var t = { last_year: 0, longest_streak: -1, longest_streak_range: [], current_streak: 0, current_streak_range: [], weeks: [], days: [], last_contributed: null },
          ...
          if (e.startsWith("<g transform")) return r.length && t.weeks.push(r) && (r = []);var o = e.match(/fill="(#[a-z0-9]+)"/),
            ...
            var c = { fill: o, date: new Date(u), count: s, level: n.indexOf(o) };0 === t.current_streak && (t.current_streak_range[0] = c.date), c.count ? (++t.current_streak, t.last_year += c.count, t.last_contributed = c.date, t.current_streak_range[1] = c.date) : (a(), t.current_streak = 0), r.push(c), t.days.push(c);
          }
        }), a(), t;
      };
      ...
      function n(e, t) {
        var n = 0,
            r = [];if (Array.isArray(e)) for (; n < e.length && t(e[n], n, e) !== !1; ++n) {} else if ("object" === ("undefined" == typeof e ? "undefined" : _typeof(e)) && null !== e) for (r = Object.keys(e); n < r.length && t(e[r[n]], r[n], e) !== !1; ++n) {}
      }t.exports = n;
    }, {}], 10: [function (e, t) {
          ...
          n(this, e), this.obj = t || {}, this.re = new RegExp("^(" + Object.keys(t).map(o).join("|") + ")");
            ...
            var n = "";t = t || [];do {
              var r = e.match(this.re),
                  a = r && r[1],
                  o = a || e.charAt(0);if (a) {
                var u = this.obj[a];"function" == typeof u && (u = u.apply(this, t)), n += u;
      ...
      t.exports = function (e, t, n) {
        var r = [],
            a = e.length;if (0 === a) return r;var o = 0 > t ? Math.max(0, t + a) : t || 0;for (void 0 !== n && (a = 0 > n ? n + a : n); a-- > o;) {
          r[a - o] = e[a];
        }return r;
      };
    }, {}] }, {}, [1])(1);
